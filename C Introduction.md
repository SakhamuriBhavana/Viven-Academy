...
**Type of daa stord in corressponding varibale**
            ...
            <pre> ```text +-------------------------------------------------+ | TYPES OF DATA STORED IN CORRESPONDING VARIABLE | +-------------------------------------------------+ | +--------------------+--------+--------+------------------+ | | | | +------------+ +---------------+ +----------------+ +------------------+ | Numerics | | Characters | | Strings | | Other Types | +------------+ +---------------+ +----------------+ +------------------+ | | | | +----------------+ +----------------+ +------------------+ +---------------------+ | Integer Types | | char (1 byte) | | Array of chars | | Derived & User- | | (Whole Nos.) | | Stores single | | Ends with '\0' | | defined types | | | | character like | | Example: "Hi" | | (struct, array, | | | | 'A', '7', '@' | +------------------+ | union, enum) | | | | ASCII encoded | | +----------------+ +----------------+ | | - short int | | - int | | - long int | | - long long int | | - unsigned short | | - unsigned int | | - unsigned long | | - unsigned long long | +------------------+ | Floating Types | | (Decimal Nos.) | +------------------+ | - float | | - double | | - long double | +------------------+ ``` </pre>
